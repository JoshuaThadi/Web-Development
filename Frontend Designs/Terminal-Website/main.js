...
function commander(cmd) {
    switch (cmd.toLowerCase()) {
        ...
        case "cd scripts":
            ...
            sheet1.addRule('#liner::before', 'content: "⚡@Browsercom$$MasterJudah!:~/scripts➤"');
            break;

        case "cd ./scripts":
            currentDirectory = "scripts";
            const sheet2 = document.styleSheets(0);
            sheet2.addRule('#liner::before', 'content: "⚡@Browsercom$$MasterJudah!:~/scripts➤"');
            break;

        case "cd ..":
            currentDirectory = "";
            const sheet3 = document.styleSheets(0);
            sheet3.addRule('#liner::before', 'content: "⚡@Browsercom$$MasterJudah!:~➤"');
            break;

        case "cd /home/user/client/scripts":
            currentDirectory = "scripts";
            const sheet4 = document.styleSheets(0);
            sheet4.addRule('#liner::before', 'content: "⚡@Browsercom$$MasterJudah!:~/scripts➤"');
            break;
        
        case "cd ~/scripts":
            currentDirectory = "scripts";
            const sheet5 = document.styleSheets(0);
            sheet5.addRule('#liner::before', 'content: "⚡@Browsercom$$MasterJudah!:~/scripts➤"');
            break;

        case "cd":
            currentDirectory = "";
            const sheet6 = document.styleSheets(0);
            sheet6.addRule('#liner::before', 'content: "⚡@Browsercom$$MasterJudah!:~➤"');
            break;
